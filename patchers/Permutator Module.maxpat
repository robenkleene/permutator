...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 496.0, 464.0, 86.0, 20.0 ],
					"text" : "prepend append"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 496.0, 432.0, 24.0, 20.0 ],
					"text" : "iter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "clear" ],
					"patching_rect" : [ 496.0, 392.0, 44.0, 20.0 ],
					"text" : "t l clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 311.0, 423.0, 86.0, 20.0 ],
					"text" : "prepend append"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 271.0, 319.0, 52.0, 20.0 ],
					"text" : "t b l clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 311.0, 375.0, 24.0, 20.0 ],
					"text" : "iter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "", "", "", "int", "", "int" ],
					"patching_rect" : [ 191.0, 239.0, 151.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 174.0, 46.0, 77.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 190.0, 142.0, 29.5, 20.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 190.0, 206.0, 57.0, 20.0 ],
					"saved_object_attributes" : 					{
						"_persistence" : 1
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 174.0, 78.0, 87.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 174.0, 110.0, 49.0, 20.0 ],
					"text" : "live.path"
				}
